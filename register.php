                            ...
                            <div class="col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre1" id="nombre1" class="form-control"
                                        placeholder="Juan" required maxlength="20">
                                </div>
                            </div>
                            <div class="col-xl-3">
                                <div class="form-group">
                                    <label for="nombre2">Segundo nombre</label>
                                    <input type="text" name="nombre2" id="nombre2" class="form-control" maxlength="20">
                                </div>
                            </div>
                            <div class="col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="apellido1" id="apellido1" class="form-control"
                                        placeholder="Pérez" required maxlength="20">
                                </div>
                            </div>
                            <div class="col-xl-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="numeroInterior" id="numeroInterior" class="form-control"
                                        maxlength="10">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="colonia" id="colonia" class="form-control" maxlength="40">
                                </div>
                            </div>
                            <div class="col-xl-3">
                                <div class="form-group">
                                    <label for="codigoPostal">*Código postal</label>
                                    <input type="text" name="codigoPostal" id="codigoPostal" class="form-control" maxlength="10">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
