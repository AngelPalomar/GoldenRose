...
<head>
    ...
    <title>Modificar inventario - Golden Rose</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"><i class="fas fa-box"></i> Modificar inventario</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <input type="number" name="cantidad" id="cantidad" class="form-control"
                                            maxlength="25" required value="<?=$datosInventario['CANTIDAD']?>">
                                    </div>
                                </div>
