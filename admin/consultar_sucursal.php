...
<head>
  ...
  <title>Consultar sucursal - Golden Rose</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center"><i class="fas fa-search"></i> Buscar sucursal</h1>
          <div class="row">
...
<script type="text/javascript">
  function buscarSucursal() { 
    $.ajax({
      type: "POST",
      url: "../scripts/consultar_sucursal.php",
      data: "sucursal=" + $('#id').val(),
