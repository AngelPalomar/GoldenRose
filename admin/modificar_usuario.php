          ...
          <form action="../scripts/modificar_usuario.php" method="post" class="pt-4">
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-2">
                  <input type="text" name="id" id="id" value="<?=$usuario_datos['id']?>" class="form-control" readonly>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <select name="tipo" id="tipo" class="form-control" required>
                    <option selected value="cliente" <?=$usuario_datos['tipoUsuario'] == 'cliente' ? 'selected="selected"' : NULL?>>Cliente</option>
                    <option value="empleado" <?=$usuario_datos['tipoUsuario'] == 'empleado' ? 'selected="selected"' : NULL?>>Empleado</option>
                    <option value="admin" <?=$usuario_datos['tipoUsuario'] == 'admin' ? 'selected="selected"' : NULL?>>Administrador</option>
                  </select>
                </div>
              </div>
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <select name="estatus" id="estatus" class="form-control" required>
                    <option selected value="activo" <?=$usuario_datos['estado'] == 'activo' ? 'selected="selected"' : NULL ?>>Activo</option>
                    <option value="inactivo" <?=$usuario_datos['estado'] == 'inactivo' ? 'selected="selected"' : NULL ?>>Inactivo</option>
                  </select>
                </div>
              </div>
            </div>
