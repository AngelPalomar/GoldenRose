              ...
              <div class="form-group">
                ...
                <div class="row">
                  <div class="col-sm-3 form-group">
                    ...
                    <input type="number" name="id" id="id" maxlength="12" placeholder="12 dígitos (UPC)" class="form-control" required>
                  </div>
                  ...
                  <div class="col-sm-3 form-group">
                    ...
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        ...
                        <input type="number" name="costo" id="costo" class="form-control" maxlength="11" placeholder="00.00" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <textarea name="desc" id="desc" cols="132" rows="5" maxlength="256" class="form-control" required></textarea>
                  </div>
                  <div class="col-sm-6 form-group">
                    <label for="desc">*Descripción ampliada (características) del producto</label>
                    <textarea name="desc" id="desc" cols="132" rows="5" maxlength="512" class="form-control" required></textarea>
                  </div>
                </div>
