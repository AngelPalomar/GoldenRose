        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"><i class="fas fa-copyright"></i> Agregar categoria
                    </h1>

                    <?php if(isset( $_GET['mensajeAgregar'])) : ?>
                    <?php switch ( $_GET['mensajeAgregar'] ) : case 2: ?>
                    <div class="alert alert-danger alert-dismissible fade show mt-4" role="alert">
                        <strong><i class="fas fa-times-circle"></i> La categoria no pudo ser agregada.</strong> <br />
                    ...
                    <?php case 3: ?>
                    <div class="alert alert-danger alert-dismissible fade show mt-4" role="alert">
                        <strong><i class="fas fa-times-circle"></i> El categoria no pudo ser agregada.</strong> <br />
                    ...
                    <form action="../scripts/agregar_categoria.php" method="post" class="pt-4">
                        <h4 class="h4 mb-4 text-gray-800">Datos de la categoria</h4>
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="categoria">*Nombre de la categoria</label>
                                    <input type="text" name="categoria" id="categoria" class="form-control" required maxlenght="20">
                                </div>
                            </div>
                        </div>
