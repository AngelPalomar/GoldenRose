        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"><i class="fas fa-copyright"></i> Modificar categoria
                    </h1>
                    ...
                    <form action="../scripts/modificar_categoria.php" method="post" class="pt-4">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="id" id="id" value="<?= $categoria_datos['id'] ?>"
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control"
                                        value="<?= $categoria_datos['nombre'] ?>" required>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                ...
                                <select name="estado" id="estado" class="form-control" required>
                                    ...
                                    <option value="activo"
                                        <?= $categoria_datos['estado'] == 'activo' ? 'selected="selected"' : NULL ?>>
                                        Activo</option>
                                    <option value="inactivo"
                                        <?= $categoria_datos['estado'] == 'inactivo' ? 'selected="selected"' : NULL ?>>
                                        Inactivo</option>
                                </select>
                            </div>
                        </div>
