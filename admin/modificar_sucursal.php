          ...
          <?php if(isset( $_GET['mensajeModificar'])) : ?>
            <?php switch ( $_GET['mensajeModificar'] ) : case 2: ?>
              <div class="alert alert-danger alert-dismissible fade show mt-4" role="alert">
                <strong><i class="fas fa-times-circle"></i> Los datosd de la scursal no pudieron ser modificados.</strong> <br/>
                <span>Verifique que los datos del la sucursal sean correctos.</span> 
              ...
              <div class="alert alert-danger alert-dismissible fade show mt-4" role="alert">
                ...
                <span>Verifique que los datos de la dirección sean correctos.</span> 
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>     
              ...
              <?php case 4: ?>
              <div class="alert alert-danger alert-dismissible fade show mt-4" role="alert">
                <strong><i class="fas fa-times-circle"></i> La sucursal no pudo ser modificado.</strong> <br/>
                <span>Verifique con un administrador el error.</span> 
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>   
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="calle" id="calle" class="form-control" value="<?=$sucursal_datos['calle']?>" maxlength="25" required>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    <label for="nE">*No. exterior</label>
                    <input type="text" name="nE" id="nE" class="form-control" value="<?=$sucursal_datos['numeroExterior']?>" maxlength="10" required>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    <label for="nI">*No. interior</label>
                    <input type="text" name="nI" id="nI" class="form-control" value="<?=$sucursal_datos['numeroInterior']?>" maxlength="10">
                  </div>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="col" id="col" class="form-control" value="<?=$sucursal_datos['colonia']?>" maxlength="40" required>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    <label for="cp">*Código postal</label>
                    <input type="text" name="cp" id="cp" class="form-control" value="<?=$sucursal_datos['codigoPostal']?>" maxlength="10" required>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="nom1" id="nom1" class="form-control" value="<?=$sucursal_datos['nombre']?>" maxlength="20" required >
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <select name="estatus" id="estatus" class="form-control" required>
                      <option selected value="activo" <?=$sucursal_datos['estatus'] == 'activo' ? 'selected="selected"' : NULL ?>>Activo</option>
                      <option value="inactivo" <?=$sucursal_datos['estatus'] == 'inactivo' ? 'selected="selected"' : NULL ?>>Inactivo</option>
                    </select>
                  </div>
                </div>
              </div>
